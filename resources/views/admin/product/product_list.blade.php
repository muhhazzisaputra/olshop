	          	...
	          	<div class="card">
	              	<div class="card-header">
	                	...
	                	<div class="card-tools"> 
			              	<a href="/admin/product/create" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
			            </div>
	              	</div>
	              	<div class="card-body">
	                	<table id="tbl-product" class="table table-bordered table-striped">
	                  		...
	                  		<tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	@if($product->image) 
                                		<img src="{{ asset('storage/'.$product->image) }}" width="90px">
                                		@else
                                    ...
                                    <td>
                                    	@if($product->status == '0')
                                    	<span class="right badge badge-danger">Disabled</span>
                                    	@else
                                    ...
                                    <td class="project-actions text-center">
				                    	<a href="/admin/product/{{ $product->slug }}/edit" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i> Edit</a>
